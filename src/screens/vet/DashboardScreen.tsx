    ...
    <Screen title="Vet Portal" subtitle={`Dr. ${user?.first_name} ${user?.last_name}`}>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', gap: Spacing.sm, marginHorizontal: Spacing.md, marginTop: Spacing.sm, marginBottom: 4 }}>
          <Button label="All Bookings" onPress={() => navigation.navigate('Bookings')} variant="secondary" style={{ flex: 1 }} />
          <Button label="My Services"  onPress={() => navigation.navigate('Services')} variant="primary"   style={{ flex: 1 }} />
        </View>
        ...
        <SectionTitle title="All Upcoming" action="See all" onAction={() => navigation.navigate('Bookings')} />
