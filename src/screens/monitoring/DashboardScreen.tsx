    ...
    <Screen title="Field Monitor" subtitle={`${user?.first_name} ${user?.last_name}`}>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', gap: Spacing.sm, marginHorizontal: Spacing.md, marginTop: Spacing.sm, marginBottom: 4 }}>
          <Button label="View Farms"     onPress={() => navigation.navigate('Farms')}  variant="secondary" style={{ flex: 1 }} />
          <Button label="Submit Report"  onPress={() => navigation.navigate('Report')} variant="primary"   style={{ flex: 1 }} />
        </View>

        <SectionTitle title="Assigned Farms" action="View all" onAction={() => navigation.navigate('Farms')} />
        {farms.length === 0
                ...
                <Card key={f.id} style={styles.farmCard}>
                  <View style={styles.farmRow}>
                    ...
                    <View style={{ alignItems: 'flex-end', gap: 6 }}>
                      ...
                      {!lastReport && (
                        <Button label="Audit" onPress={() => navigation.navigate('Report')} size="sm" variant="primary" />
                      )}
                    </View>
                  </View>
                </Card>
