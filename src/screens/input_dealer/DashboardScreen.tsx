    ...
    <Screen title="Input Dealer" subtitle={`${user?.first_name} ${user?.last_name}`}>
      ...
      >
        ...
        <View style={{ paddingHorizontal: Spacing.md, marginTop: Spacing.sm, marginBottom: 4 }}>
          <Button label="+ Add New Input" onPress={() => navigation.navigate('Listings')} variant="primary" fullWidth />
        </View>

        <SectionTitle title="My Listings" action="Manage all" onAction={() => navigation.navigate('Listings')} />
        {listings.length === 0
